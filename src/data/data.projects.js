export const projectsData = [
    {
        ...
        arrImg: [
            ...
            require('../assets/images/bathroom/bathroom3.jpg'),
            require('../assets/images/bathroom/bathroom4.jpg'),
            require('../assets/images/bathroom/bathroom6.jpeg'),
            require('../assets/images/bathroom/bathroom5.jpeg'),
        ],
        textInProjects: `А ось і <span>результати роботи</span> з попереднього проєкту. 
        На фото Ви можете спостерігати як перетворити доволі скромні квадратні метри 
        на дуже приємну та комфортну ванну кімнату. 
        Такий варіант не тільки задовольнить практичну функцію, а й доведе свою естетичність.`
...

    {
        ...
        title: 'ВАННА КІМНАТА ЖК «СУПЕРНОВА»',
        ...
        arrImg: [
            require('../assets/images/bathroomSuperNova/1.jpeg'),
            require('../assets/images/bathroomSuperNova/2.jpeg'),
            require('../assets/images/bathroomSuperNova/3.jpeg'),
            require('../assets/images/bathroomSuperNova/4.jpeg'),
            require('../assets/images/bathroomSuperNova/5.jpeg'),
            require('../assets/images/bathroomSuperNova/6.jpeg'),
        ],
        textInProjects: `<span>Ванна кімната</span> у ЖК «Супернова»
            Невеличка кімната, у якій все ж вмістилось все необхідне. 
            Доволі мінімалістичний дизайн із сучасною сантехнікою. 
            Для візуального збільшення простору також використали елементи 
            дрібної плитки разом із іншою, щоб отримати максимальний ефект. 
            Невеличкі ж візерунки тільки довершили дизайн інтер‘єру. 
            Що ж головне, то це виконання усіх побажань замовника. 
            Для нас це найважливіше.`
    },
    {
        id: 4,
        ...
        arrImg: [
            ...
            require('../assets/images/kitchenSuperNova/3.jpeg'),
            require('../assets/images/kitchenSuperNova/4.jpeg'),
            require('../assets/images/kitchenSuperNova/5.jpeg'),
            require('../assets/images/kitchenSuperNova/6.jpeg'),
        ],
        textInProjects: `
        Ремонтна <span>робота із кухнею</span>. 
        У цій кімнаті важливо було зберегти загальний інтер‘єр оселі та зробити його більш практичним, 
        оскільки кухня — це місце і готування, і відпочинку. 
        Таке завдання вміло виконується, коли майстер ухвалює правильні рішення при роботі, 
        щоб потім мати гарний результат.  
        Тоді кухня витримає безліч кулінарних авантюр та сімейних застіль.
        `
    },
    {
        id: 5,
...

    {
        ...
        arrImg: [
            ...
            require('../assets/images/bathroom2/2.jpeg'),
            require('../assets/images/bathroom2/3.jpeg'),
            require('../assets/images/bathroom2/4.jpeg'),
        ],
        textInProjects: `
        <span>Модерна ванна</span> кімната у достатньо просторому місці. Завдяки правильному вибору 
        матеріалів нам удалося підібрати і плитку, і дерево в унітарному стилі. 
        Така загальна композиція створює сучасний та приємний інтер‘єр для кожного відвідувача. 
